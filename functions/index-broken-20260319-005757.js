...
// CORS middleware - allow multiple origins, credentials enabled
const corsMiddleware = cors({
  origin: ['https://hands-detail.web.app', 'https://handsdetailshop.com', 'http://localhost:3000', 'http://localhost:8080'],
  credentials: true,
